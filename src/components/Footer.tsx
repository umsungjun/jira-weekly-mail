  ...
  return (
    <footer className="bg-gray-900 text-gray-400 py-12">
      <div className="max-w-5xl mx-auto px-6 text-center">
        <p className="text-white font-bold text-lg mb-1">Jira Weekly Reporter</p>
        <p className="text-sm mb-6">Jira + Gemini AI로 주간 업무 보고를 자동화하세요</p>
        ...
        <p className="text-xs text-gray-600">
          © {new Date().getFullYear()} umsungjun · MIT License
        </p>
      </div>
    </footer>
  );
